...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ReleaseManagement2ConnectionString %>" SelectCommand="SELECT [teamleadid], [teamid], [managerid] FROM [TeamLead]"></asp:SqlDataSource>
