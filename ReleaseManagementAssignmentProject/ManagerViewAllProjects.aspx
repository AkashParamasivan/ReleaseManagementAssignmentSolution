...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ReleaseManagement2ConnectionString2 %>" SelectCommand="SELECT [pid], [pname], [pdesc], [preq], [pstatus] FROM [project]"></asp:SqlDataSource>
</asp:Content>
